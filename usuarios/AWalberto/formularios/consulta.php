...
<body>
	...
	<form action="consultas/ver todos mobiliario.php" method="get">
		...
		<input class="boton" type="submit" name="Consultar" value="Consultar Mobiliarios">
	</form>
	...
	<br>
	<br>
	<input class="boton"  type="submit" name="consultar" value="Consultar Mobiliario">
	</form>
	<br>
	<br>
	<br>
	...
	<form action="consultas/c_empleado.php" method="get">
		...
		<input class="boton" type="submit" name="Consultar" value="Consultar Empleados">
	</form>
	...
	<br>
	<br>
	<input class="boton"  type="submit" name="consultar" value="Consultar Empleado">
	</form>
	<br>
	<br>
	<br>
	...
	<form action="consultas/c_plan_trabajo.php" method="get">
		...
		<input class="boton" type="submit" name="Consultar" value="Consultar Planes de Trabajo">
	</form>
	...
	<br>
	<br>
	<input class="boton"  type="submit" name="consultar" value="Consultar Plan de Trabajo">
	</form>
	<br>
	<br>
	<br>
	...
	<form action="consultas/c_certificado.php" method="get">
		...
		<input class="boton" type="submit" name="Consultar" value="Consultar Certificados o Titulos">
	</form>
	...
	<br>
	<br>
	<input class="boton"  type="submit" name="consultar" value="Consultar Certificado o Titulo">
	</form>
	<br>
	<br>
	<br>
	...
	<form action="consultas/c_nomina.php" method="get">
		...
		<input class="boton" type="submit" name="Consultar" value="Consultar Recibos de Nomina">
	</form>
	...
	<br>
	<br>
	<input class="boton"  type="submit" name="consultar" value="Consultar Recibo de Nomina">
	</form>
	<br>
	<br>
	<br>
	...
	<form action="consultas/c_minuta.php" method="get">
		...
		<input class="boton" type="submit" name="Consultar" value="Consultar Minutas">
	</form>
	...
	<br>
	<br>
	<input class="boton"  type="submit" name="consultar" value="Consultar Minuta">
	</form>
	<br>
	<br>
	<br>
	...
	<form action="consultas/c_test.php" method="get">
		...
		<input class="boton" type="submit" name="Consultar" value="Consultar Test de Necesidades">
	</form>
	...
	<form action="consultas/c_manual.php" method="get">
		...
		<input class="boton" type="submit" name="Consultar" value="Consultar Manuales se Usuario">
	</form>
	...
	<br>
	<br>
	<input class="boton"  type="submit" name="consultar" value="Consultar Manual de Usuario">
	</form>
	<br>
	<br>
	<br>
	...
	<form action="consultas/c_curriculum.php" method="get">
		...
		<input class="boton" type="submit" name="Consultar" value="Consultar Curriculums">
	</form>
	...
	<br>
	<br>
	<input class="boton"  type="submit" name="consultar" value="Consultar Curriculum">
	</form>
	<br>
	<br>
	<br>
	...
	<form action="consultas/c_analisis.php" method="get">
		...
		<input class="boton" type="submit" name="Consultar" value="Consultar Analisis de Recurosos Necesarios">
	</form>
	...
	<br>
	<br>
	<input  class="boton" type="submit" name="consultar" value="Consultar Anailsis de Recursos Necesarios">
	</form>
	<br>
	<br>
	<br>
	...
	<form action="consultas/c_proyecto.php" method="get">
		...
		<input class="boton" type="submit" name="Consultar" value="Consultar Proyectos Documentados">
	</form>
	...
	<br>
	<br>
	<input class="boton"  type="submit" name="consultar" value="Consultar Proyecto Documentado">
	</form>
	<br>
	<br>
	<br>
	...
	<form action="consultas/c_informe.php" method="get">
		...
		<input class="boton" type="submit" name="Consultar" value="Consultar Informes o Reportes">
	</form>
	...
	<br>
	<br>
	<input class="boton"  type="submit" name="consultar" value="Consultar Informe o Reporte">
	</form>
	<br>
	<br>
	<br>
	...
	<form action="consultas/c_contrato.php" method="get">
		...
		<input class="boton" type="submit" name="Consultar" value="Consultar Contratos ">
	</form>
	...
	<br>
	<br>
	<input class="boton"  type="submit" name="consultar" value="Consultar contrato">
	</form>
	<br>
	<br>
	<br>
	...
	<form action="consultas/c_servicios.php" method="get">
		...
		<input class="boton" type="submit" name="Consultar" value="Consultar Servicios">
	</form>
	...
	<br>
	<br>
	<input class="boton"  type="submit" name="consultar" value="Consultar Servicio">
	</form>
	<br>
	<br>
	<br>
	...
	<form action="consultas/c_cliente.php" method="get">
		...
		<input class="boton" type="submit" name="Consultar" value="Consultar Clientes">
	</form>
	...
	<br>
	<br>
	<input class="boton"  type="submit" name="consultar" value="Consultar Cliente">
	</form>
	<br>
	<br>
	<br>
	...
	<form action="consultas/c_factura.php" method="get">
		...
		<input class="boton" type="submit" name="Consultar" value="Consultar Facturas">
	</form>
	...
	<br>
	<br>
	<input class="boton"  type="submit" name="consultar" value="Consultar Factura">
	</form>
	<br>
	<br>
	<br>
	...
	<form action="consultas/c_orden.php" method="get">
		...
		<input class="boton" type="submit" name="Consultar" value="Consultar Orden se Servicio">
	</form>
	...
	<br>
	<br>
	<input class="boton"  type="submit" name="consultar" value="Consultar Orden de Servicio">
	</form>
	<br>
	<br>
	<br>
	...
	<form action="consultas/c_queja.php" method="get">
		...
		<input class="boton" type="submit" name="Consultar" value="Consultar Formularios de Queja">
	</form>
